...
describe('AuthorsPrismaRepository Integration Tests', () => {
  ...
  test('should throws an error when the id is not found', async () => {
    await expect(
      repository.findById('a8ce5741-226f-4179-b29f-dd0e4bf516ff'),
    ).rejects.toThrow(
      new NotFoundError(
        'Author not found using ID a8ce5741-226f-4179-b29f-dd0e4bf516ff',
      ),
    )
  })

  test('showld find an author by id', async () => {
  ...
  test('should create a author', async () => {
    ...
    expect(author).toMatchObject(author)
  })
